...
public class UserServiceImpl implements UserService {
	...
	public UserTO update(UserTO userTo) {
		...
		log.debug("UserServiceImpl : UPDATE");
	...
	private StaffTO getPopulatedUserTO(User user) {
		StaffTO staff = null;
		log.debug("UserServiceImpl : getPopulatedUserTO");
	...
	private User getPopulatedUser(UserTO userTO) {
		...
		log.debug("UserServiceImpl : getPopulatedUser");
		...
		if (userTO != null) {
			...
			log.debug("UserServiceImpl : userTO.getUserType()"+userTO.getUserType());
	...
	public List<UserTO> fetchAllUser() {
		log.debug("UserServiceImpl : fetchAllStaff");
		...
		log.debug("UserServiceImpl : fetchAllStaff : LIST [" + staffs + "]");
	...
	public UserTO findUserByEmail(String email) {
		...
		UserTO userTo = null;
		if (userRet != null) {
			log.debug("UserServiceImpl : findUserByEmail : User [" + userRet.getId() + "]");
