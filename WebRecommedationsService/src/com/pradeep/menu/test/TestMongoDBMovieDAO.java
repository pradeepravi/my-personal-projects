...
public class TestMongoDBMovieDAO {
	...
	public void testGetMovies() {
		...
		try {
			System.out.println(
					"FETCH MOVIE FOR SEARCH STRING - " + movieDao.getMovies(Arrays.asList("The Martian")).size());
	...
	public void testGetAllMoviesForActorsOrderByRating() {
		/*
		 * List<String> directors = new ArrayList<>(); directors.add("Brian");
		 */
		...
		try {
			System.out.println(" [testGetAllMoviesForActorsOrderByRating] ***** "
					+ movieDao.getMoviesByRating(genres, null, actors).size());
		} catch (WebRecommendationsException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void testRecommendationsForWatchedMovies() {
		...
		/*
		 * List<String> watchedMovies = new ArrayList<>(); watchedMovies.add(
		 * "The Martian");
		 */
	...
	@Test
	public void testMockecommendationsList() {
		/*
		 * List<String> directors = new ArrayList<>(); directors.add("Brian");
		 */
		...
		try {
			...
			// "+movieRecommendations.getRecommendations(paramsMap).size());
			System.out.println("*****************For Watched Movie -> " + list);
			List<Recommendation> recomme = movieRecommendations.getMockTestRecommendations();
			System.out.println(recomme);
		} catch (NoSuchMethodException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
